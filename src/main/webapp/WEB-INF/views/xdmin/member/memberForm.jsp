...
<!-- <form method="get" action="/infra/xdmin/member/memberInst">
...
<!-- 							<label for="nickname">ㄴㅁㅇㅁㄴㅇ </label> -->
					...
					<div class="mb-4"></div>
					<button class="btn btn-primary btn-lg btn-block" type="submit">asd</button>
					<input type="submit" value="제출5">
				</form>
			</div>
		</div>
